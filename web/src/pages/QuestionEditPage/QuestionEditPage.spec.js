import QuestionEditPage from './QuestionEditPage.vue';
import {
  render,
  screen,
...
// it('has Front Input whose initially value is the same as returned from server', async () => {
//   store.dispatch('setUser', userData);
//   setup();
//   const frontInput = await screen.findByTestId('front-input');
//   expect(frontInput.value).toBe(questionsData[0].front);
// });
